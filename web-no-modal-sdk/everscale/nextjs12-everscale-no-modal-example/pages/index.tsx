...
import RPC from "@/lib/everscaleRPC";
import { TonClientContext, TON_ENDPOINT } from "@/lib/context/tonclient";
  ...
  return (
    <div className="container">
      ...
      <footer className="footer">
        <a
          href="https://github.com/Web3Auth/examples/tree/main/web-modal-sdk/everscale/nextjs12-everscale-no-modal-example"
          target="_blank"
